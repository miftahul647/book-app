    ...
    <div class="modal-dialog">
      <div class="modal-content">
          <div class="modal-header">
            <h1 class="modal-title fs-5" id="exampleModalLabel">Tambah Variabel</h1>
          ...
          <div class="modal-footer">
            ...
            <button type="button" data-bs-dismiss="modal" onclick="handleSaveVariabel(this)" class="btn btn-primary">Simpan</button>
          </div>
      </div>
    </div>
  </div>